...
/* ======================================================
   PANEL MENU KIRI
   Menggunakan marker .brand-box agar stabil di Streamlit Cloud
   ====================================================== */
div[data-testid="column"]:has(.brand-box) {
    background: #0F4C81 !important;
    border-right: 5px solid #2F80ED !important;
    min-height: 100vh !important;
    padding: 20px 15px !important;
    border-radius: 0 15px 15px 0 !important;
    box-shadow: 5px 0 20px rgba(0,0,0,.15) !important;
}
...
/* ======================================================
   TOMBOL MENU KIRI
   Dipaksa rata kiri, font kecil, dan warna stabil
   ====================================================== */
div[data-testid="column"]:has(.brand-box) div[data-testid="stButton"] > button {
    width: 100% !important;
...
div[data-testid="column"]:has(.brand-box) div[data-testid="stButton"] > button p {
    width: 100% !important;
    margin: 0 !important;
    padding: 0 !important;
    text-align: left !important;
...
div[data-testid="column"]:has(.brand-box) div[data-testid="stButton"] > button:hover {
    background: #2F80ED !important;
    color: #ffffff !important;
}

div[data-testid="column"]:has(.brand-box) div[data-testid="stButton"] > button[kind="primary"] {
    background: #2F80ED !important;
    color: #ffffff !important;
