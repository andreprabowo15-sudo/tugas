...
div[data-testid="stHorizontalBlock"] > div[data-testid="column"]:first-child{
    ...
    /* Tombol menu: stabil di localhost dan Streamlit Cloud */
    ...
    section.main div[data-testid="column"]:first-child div[data-testid="stButton"] > button p {
        width: 100% !important;
        margin: 0 !important;
        padding: 0 !important;
        text-align: left !important;
    ...
    section.main div[data-testid="column"]:first-child div[data-testid="stButton"] > button[kind="primary"] {
        background: #2F80ED !important;
        color: #ffffff !important;
